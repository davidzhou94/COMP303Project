...
public final class Card implements Comparable<Card>
{
    ...
    {
        int thisCardOrdinal = this.getRank().ordinal() * 4 + this.getSuit().ordinal();
        int pCardOrdinal = pCard.getRank().ordinal() * 4 + pCard.getSuit().ordinal();
    ...
    public int hashCode() 
    {
        return ( this.getSuit().ordinal() ) * 13 + (this.getRank().ordinal() + 1);
    }
}